...
const createInitialRoutine = async (db: Firestore, academicYear: string): Promise<ClassRoutine[]> => {
    ...
    '6': {
        ...
        'বৃহস্পতিবার': ['বাও বি - জান্নাতুন', 'বাংলা ২য় - যুধিষ্ঠির', 'ইংরেজী ১ম - আরিফুর', 'বাংলা ১ম - ওবায়দা', 'ইংরেজী ২য় - যুধিষ্ঠির', 'বিজ্ঞান - শান্তি'],
    },
    '7': {
    ...
    '8': {
        ...
        'বৃহস্পতিবার': ['শারীরিক - নীলা', 'কৃষি - মাহাবুব', 'গণিত - ধনঞ্জয়', 'কৃষি - মাহাবুব', 'ইংরেজী ১ম - আরিফুর', 'বিজ্ঞান - শান্তি'],
    },
    '9': {
